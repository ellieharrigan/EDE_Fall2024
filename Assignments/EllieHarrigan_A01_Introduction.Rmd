...
> Answer: I have no experience with R and Git. I have used Python before in ArcGIS pro, which is where most of my data analytics and geospatial data experience is.

2. Are there any components of the course about which you feel confident?

> Answer: Using R scripts to run in ArcGIS pro and transferring spatial data.

3. Are there any components of the course about which you feel apprehensive?

> Answer: The initial learning curves with R. 
...
> Answer: https://github.com/ellieharrigan/EDE_Fall2024 
