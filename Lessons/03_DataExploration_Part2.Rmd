...
>Answer: It helps us get a better understanding of what the data is telling us, such as trends and markers. It also helps us to see where there may be mistakes in the data, look into ways to better organize the data that will help empower your work. Data exploration can help aid in decision-making for data analysis steps further down the pipeline by simply understanding what the data is showing, and what are the best ways to analyse this data to empower your work and help tell the story. 
...
> Answer: Discharge.mean is higher at recorruing dates, possibly could show a trends in those repeating months and weather patterns.
