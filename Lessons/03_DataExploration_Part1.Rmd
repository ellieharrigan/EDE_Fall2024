...
> Answer: It is loaded in your R session. When you stop and reopoen that session you'll have to reload the package. 
...
here("./Data/Raw/USGS_Site02085000_Flow_Raw.csv")
...
> ANSWER: Came from Eno River in Hillsboro, NC. Data was collected using the Current Conditions Tool. USGS collected to understand streamflow. Date of collection goes back to 1928, how is that data collected differently from present collection. File path is given in readme text for easy location and reproducibility. 
...
> Answer: Research questions pertaining summary statistics is an example where NAs should be removed from a dataset. Such as what is the proportion of protected habitat of an imperiled species inside a study area. 
