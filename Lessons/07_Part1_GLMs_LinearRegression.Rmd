...
#linear regression is used to analyze a continuous response variable (y) and (x), show relationships between two variables. The above equation is for linear regression. a = intercept, B = slope coefficient, e= residual term (pouits away from regression line)
