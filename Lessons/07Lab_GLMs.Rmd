...
plot3 <-
  ggplot(EPAair, aes(as.factor(Year),
                     y= Ozone)) +
...
libary(dplyr)
library(corrplot)
#cor function will only compare numerical values of your dataset
...
EPA.model <- lm(data = EPAair.subset, PM2.5 ~ Ozone + mean_Lat + mean_Lng + Month + Year)
